...
determine freshness, stop and report the blocker. Unsupported custom completion
records or immediate backlog promotion requests are blocked until the CLI
supports them or the user authorizes a separate non-todo cleanup path.
