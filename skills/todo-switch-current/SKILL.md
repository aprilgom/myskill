...
determine freshness, stop and report the blocker. Unsupported priority
rationale or other note changes are blocked until the CLI supports them or the
user authorizes a separate non-todo cleanup path.
