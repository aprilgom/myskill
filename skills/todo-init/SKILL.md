...
Do not manually create or edit living-plan files as a fallback for missing,
unbuilt, failing, or stale CLI state. If CLI readiness or freshness cannot be
confirmed, the todo workflow is blocked.
